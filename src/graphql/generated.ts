...
export type SendMessageQueryVariables = Exact<{ [key: string]: never }>;

export type SendMessageQuery = {
	__typename?: "Query";
	Send_to_queue: { __typename?: "Historic_Stats"; id: string };
};
...
export const GetAugmentsDocument = `
  ...
  Augments {
    ...
    `;
export const useGetAugmentsQuery = <TData = GetAugmentsQuery, TError = unknown>(
	...
	useQuery<GetAugmentsQuery, TError, TData>(
		...
		fetcher<GetAugmentsQuery, GetAugmentsQueryVariables>(
			dataSource.endpoint,
...
export const SendMessageDocument = `
  ...
  Send_to_queue {
    ...
    `;
export const useSendMessageQuery = <TData = SendMessageQuery, TError = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	variables?: SendMessageQueryVariables,
	options?: UseQueryOptions<SendMessageQuery, TError, TData>
) =>
	useQuery<SendMessageQuery, TError, TData>(
		variables === undefined ? ["sendMessage"] : ["sendMessage", variables],
		fetcher<SendMessageQuery, SendMessageQueryVariables>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
			SendMessageDocument,
			variables
